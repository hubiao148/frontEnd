        ...
        <div className={styles['content']}>
          ...
          <div className={styles['right']}>
            <div className={styles['content-header']}>
              <a className={`${styles['title']} ${title == '请先登录账号'?styles['isActive']:null}`} onClick={goLogin}>
                登录
              </a>
              <a className={`${styles['title']} ${title == '请先注册账号'?styles['isActive']:null}`} onClick={goRegister}>注册</a>
            </div>
